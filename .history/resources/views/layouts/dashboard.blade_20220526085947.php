    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0" style="width: 3.5rem; min-height:100vh;background-color: #19a3ff;">
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center" style="margin-top: 0px;">
                <li>
                    <a href="javascript:void(0)" style="display: none;" class="nav-link py-3" id="close"
                        onclick="closeNav()">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link py-3" aria-current="page" title="Home" data-bs-toggle="tooltip"
                ...
                <li>
                    <a href="#" class="nav-link py-3" title="Dashboard" data-bs-toggle="tooltip"
                        data-bs-placement="right">
                        <i class="fa-light fa-calendar-minus"
                            style="font-size:14px;font-weight: normal;color:white;"></i>
                    </a>
                </li>
                <li>
                    <a href="#" class="nav-link py-3" title="Orders" data-bs-toggle="tooltip"
                        data-bs-placement="right">
                        <i class="fa-light fa-user" style="font-size:14px;font-weight:normal;color:white;"></i>
                    </a>
                </li>
                <li>
                    <a href="#" class="nav-link py-3" title="Products" data-bs-toggle="tooltip"
                        data-bs-placement="right">
                        <i class="fa-light fa-comment-dots" style="font-size:14px;font-weight: normal;color:white;"></i>
                    </a>
                </li>
                <li>
                    <a href="#" class="nav-link py-3" title="Customers" data-bs-toggle="tooltip"
                        data-bs-placement="right">
                ...
                <li>
                    <a href="#"
                        ...
                        <img src="https://github.com/mdo.png" alt="mdo" width="20" height="20" class="rounded-circle"
                            style="outline:solid 1px;outline-color: white;">
                    </a>
                </li>
                <li>
                    <a href="#" class="nav-link py-3" title="Dashboard" data-bs-toggle="tooltip"
        ...
        <div class="bg-white sidebar " style="display:none;" id="sidebar">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <svg class="bi me-2" width="40" height="65">
